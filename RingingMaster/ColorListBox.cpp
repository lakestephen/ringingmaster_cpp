...
//-------------------------------------------------------------------
//
void ColorListBox::DrawItem(LPDRAWITEMSTRUCT lpDIS) 
//
// Return Value:	None.
//
...
//-------------------------------------------------------------------
//
void ColorListBox::MeasureItem(LPMEASUREITEMSTRUCT lpMIS)
//
// Return Value:	None.
//
...
//-------------------------------------------------------------------
//
int ColorListBox::AddString(LPCTSTR lpszItem)
//
...
//-------------------------------------------------------------------
//
int ColorListBox::AddString(LPCTSTR lpszItem, COLORREF rgb)
//
// Return Value:	The zero-based index to the string in the list box. 
//						The return value is LB_ERR if an error occurs; the 
//						return value is LB_ERRSPACE if insufficient space 
...
//-------------------------------------------------------------------
//
int ColorListBox::InsertString(int nIndex, LPCTSTR lpszItem)
//
...
//-------------------------------------------------------------------
//
int ColorListBox::InsertString(int nIndex, LPCTSTR lpszItem, COLORREF rgb)
//
// Return Value:	The zero-based index of the position at which the 
//						string was inserted. The return value is LB_ERR if 
//						an error occurs; the return value is LB_ERRSPACE if 
...
//-------------------------------------------------------------------
//
void ColorListBox::SetItemColor(int nIndex, COLORREF rgb)
//
// Return Value:	None.
//
